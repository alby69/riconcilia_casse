...
- Name: test_worker.spec.js >> Web Worker cancellation via Annulla button works
- Location: test_worker.spec.js:46:1
...
Call log:
  - waiting for locator('#btnCancel')
    - locator resolved to <button type="button" id="btnCancel" class="btn btn-outline-danger btn-sm rounded-pill px-4 fw-semibold">…</button>
...
- generic [active] [ref=f1e1]:
  - navigation [ref=f1e2]:
    - generic [ref=f1e3]:
      - link "CashRec (Standalone)" [ref=f1e4] [cursor=pointer]:
        - /url: "#"
      - button "" [ref=f1e10] [cursor=pointer]
      - button "" [ref=f1e12] [cursor=pointer]
  - generic [ref=f1e14]:
    - img [ref=f1e16]:
      - generic [ref=f1e17]: CashRec
      - generic [ref=f1e18]: Simplify your accounts, liberate your business.
    - generic [ref=f1e20]:
      - generic [ref=f1e21]:
        - generic [ref=f1e22] [cursor=pointer]:
          - generic [ref=f1e23]: 
          - heading "Trascina qui il tuo file Excel" [level=5] [ref=f1e24]
          - paragraph [ref=f1e25]: o clicca per selezionare
        - generic [ref=f1e27] [cursor=pointer]:
          - generic [ref=f1e28]: 
          - text: Impostazioni Avanzate
          - generic [ref=f1e29]: 
        - text:     
        - button " Elabora File" [ref=f1e31] [cursor=pointer]:
          - generic [ref=f1e32]: 
          - text: Elabora File
      - text:     + 
    - generic [ref=f1e33]: v5.1 Standalone HTML App - Fully Client-Side
  - text:  
```
