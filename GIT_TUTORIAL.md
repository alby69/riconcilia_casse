# Git Tutorial for the Accounting Reconciliation Project

This quick guide covers the essential Git commands for managing this project.

## 1. Initial Setup (to be done only once)

If you are starting from scratch and want to upload the project to a new GitHub repository for the first time.
